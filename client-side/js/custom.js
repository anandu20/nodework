...
document.getElementById("filter").addEventListener('keyup',(e)=>{
    ...
    arr.filter((i)=>i.name.toLowerCase().includes(e.target.value.toLowerCase())).map((dt)=>{
        str+=`
                        <tr>
                        <td><input type="text" id="name-${dt._id}" name="name" value="${dt.name}"  placeholder="Employee Name" class="input-box"></td>
                        <td><input type="text" id="desg-${dt._id}" name="desg" value="${dt.desig} " placeholder="Designation" class="input-box"></td>
                        <td><input type="text" id="salary-${dt._id}" name="salary" value=${dt.salary} placeholder="Salary" class="input-box"></td>
                        <td><input type="text" id="exp-${dt._id}" name="exp"  value=${dt.exp}  placeholder="Experience" class="input-box"></td>
                         <td><div id="tsalary-${dt._id}"></div></td>
